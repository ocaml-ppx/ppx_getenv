...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5fd80bca7a9f8fd43670228c4185e668) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ppx_getenv", []))];
                      ...
                      bs_byteopt =
                        [
                           (OASISExpr.EBool true,
                             ["-ppx"; "lib/ppx_getenv.byte"])
                        ];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   },
                   {exec_custom = false; exec_main_is = "test_ppx_getenv.ml"});
               Test
                 ({
                     cs_name = "test_ppx_getenv";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\145\250\168J\001\192T>\222\248@\144\1499\135\153";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
